...
<div class="jam-details">
  ...
  <ul>
    ...
    <li>
      <span>WRITING ONLY:</span>
      We are trying something new this time! We will write (in small groups) a handful of short scripts, which the following film jam can optionally select from and shoot.
    </li>
    <li>
      <span>Theme:</span>
...
PAGE_DESCRIPTION = "SF Film Jam - make mistakes. finish a movie. somewhat often."
